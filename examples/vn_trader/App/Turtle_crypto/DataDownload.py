...
if __name__ == "__main__":
    ...
    if exchange == "2":
        ...
        if mode == "2":
            ...
            contract_list = ['AEVO-USDT-SWAP', 'AIDOGE-USDT-SWAP', 'ALPHA-USDT-SWAP', 'ANT-USDT-SWAP', 'AUCTION-USDT-SWAP', 'BICO-USDT-SWAP', 'BIGTIME-USDT-SWAP', 'BONK-USDT-SWAP', 'BTC-USDT-SWAP', 'CEL-USDT-SWAP', 'CORE-USDT-SWAP', 'CRV-USDT-SWAP', 'CSPR-USDT-SWAP', 'DGB-USDT-SWAP', 'ETH-USDT-SWAP', 'ETHFI-USDT-SWAP', 'FRONT-USDT-SWAP', 'HBAR-USDT-SWAP', 'JTO-USDT-SWAP', 'LOOKS-USDT-SWAP', 'LPT-USDT-SWAP', 'MEME-USDT-SWAP', 'MERL-USDT-SWAP', 'MEW-USDT-SWAP', 'MSN-USDT-SWAP', 'NEO-USDT-SWAP', 'NOT-USDT-SWAP', 'OM-USDT-SWAP', 'ONT-USDT-SWAP', 'ORBS-USDT-SWAP', 'ORDI-USDT-SWAP', 'PEOPLE-USDT-SWAP', 'PEPE-USDT-SWAP', 'SATS-USDT-SWAP', 'TIA-USDT-SWAP', 'TNSR-USDT-SWAP', 'TON-USDT-SWAP', 'TRB-USDT-SWAP', 'TURBO-USDT-SWAP', 'UMA-USDT-SWAP', 'UNI-USDT-SWAP', 'VELO-USDT-SWAP', 'W-USDT-SWAP', 'WLD-USDT-SWAP', 'YGG-USDT-SWAP', 'ZETA-USDT-SWAP', 'ZEUS-USDT-SWAP', 'ZKJ-USDT-SWAP']
