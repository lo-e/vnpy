...
class AlgoTemplate:
    ...
    def buy(
        ...
        """"""
        msg = f"委托买入{vt_symbol}：{volume}@{price}\tbid_price_1：{self.last_tick.bid_price_1}\task_price_1：{self.last_tick.ask_price_1}"
        self.write_log(msg)
    ...
    def sell(
        ...
        """"""
        msg = f"委托卖出{vt_symbol}：{volume}@{price}\task_price_1：{self.last_tick.ask_price_1}\tbid_price_1：{self.last_tick.bid_price_1}"
        self.write_log(msg)
