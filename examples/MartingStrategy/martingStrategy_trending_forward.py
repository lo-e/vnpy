    ...
    def load_backtesting_history_data(self, exchange: str, file_name: str):
        ...
        if file_name:
            ...
            file_path = Path(dir).joinpath(
                f"backtesting_history{DIR_SYMBOL}FORWARD{DIR_SYMBOL}{exchange}{DIR_SYMBOL}{file_name}"
            )
            if file_path.exists():
