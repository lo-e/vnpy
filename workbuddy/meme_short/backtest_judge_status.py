...
cumPnl 只累计 live 订单。
输出: data/backtest_short_top1_20260601_20260811_judged.csv
"""
import csv
import os
...
DAY = 24 * 3600 * 1000
LOOKBACK = 30 * DAY
SRC = os.environ.get("JUDGE_SRC", "data/change_20260101_20260812/_backtest_top1_short_all.csv")
OUT = os.environ.get("JUDGE_OUT", "data/change_20260101_20260812/_backtest_top1_short_judged.csv")
